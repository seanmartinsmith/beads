...
func (s *DoltStore) AddLabel(ctx context.Context, issueID, label, actor, session string) error {
...
func (s *DoltStore) RemoveLabel(ctx context.Context, issueID, label, actor, session string) error {
	return s.withRetryTx(ctx, func(tx *sql.Tx) error {
