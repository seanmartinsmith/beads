...
func (s *configStore) AddLabel(_ context.Context, _, _, _, _ string) error    { return nil }
func (s *configStore) RemoveLabel(_ context.Context, _, _, _, _ string) error { return nil }
