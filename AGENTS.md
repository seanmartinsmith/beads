...
See also [AGENT_INSTRUCTIONS.md](AGENT_INSTRUCTIONS.md) for the longer-form guide; this file is the canonical entry point for AI agents.
...
2. **Claim your task**: `bd update <id> --status in_progress` (or `--claim` for atomic claim)
